...
Midi.Sequence = function(midiType, frames) {
    ...
    var init = function() {
        ...
        track.addEvent(0, new Midi.Message(0xFF02, _lc.COPY_RIGHT));
    };
    
    self.setCopyRight = function(text) {
        
        buf.tracks[0].addEvent(0, new Midi.Message(0xFF02, text));
    };
    
    self.setName = function(text) {
        buf.name = text;
        buf.tracks[0].addEvent(0, new Midi.Message(0xFF03, text));
    };
